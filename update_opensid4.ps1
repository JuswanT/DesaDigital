...
$safeItems = @("desa", "storage", "backup_inkremental", ".env", ".env.docker", "Dockerfile", "installer-master", "installer-master.zip", "update_opensid.ps1", "update_opensid2.ps1", "update_opensid3.ps1", "update_opensid4.ps1")
...
Write-Host "Cloning OpenSID latest to $tempDir (shallow clone)..."
git clone --depth 1 https://github.com/OpenSID/OpenSID.git $tempDir
